...
$sDate = date("Y-m-d h:i", strtotime("-30 minutes"));
...
$pdf->Cell(34	,5,": $bookingInfo[10]",0,1);//end of line
...
$filename="../Admin/bills/$bookingInfo[10].pdf";
//Saving the PDF file to the server.
$pdf->Output($filename,'F');
//Output PDF file to print bill.
}
?>
